...
def add_to_master(embed_list: EmbedList, sent_embed):
...
def page_num(embed_list: EmbedList):
    for index, page in enumerate(embed_list.pages):
        if isinstance(page.content, discord.Embed):
